...
export class AuthService {
    ...
    constructor(
        ...
        this._logger.info('AuthService : constructor ');
         if(null==localStorage.getItem(Constants.localStorageKeys.apiToken)){
         ...
         this._logger.info('AuthService : constructor read api token ');

        this._logger.info('AuthService : constructor ended ');
    }
